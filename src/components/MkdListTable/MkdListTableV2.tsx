...
import { StringCaser, generateUUID } from "@/utils/utils";
...
export const getCorrectValueTypeFormat = (value: any, operator: string) => {
...
export const getCorrectOperator = (operator: string, value: any) => {
  if (typeof value === "number") {
